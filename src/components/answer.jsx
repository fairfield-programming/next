...
export default function Question({ data }) {
    ...
    <Card variant="bordered" pb={3}>
        ...
        <Grid mt={3} mb={0} gap={2} columns={[2, '1fr 1fr']}>
            <Link p={0} m={0} sx={{display: 'flex', textDecoration: 'none', textAlign: "center", opacity: 0.5}}>
            ...
            <Link p={0} m={0} href={`#answer-${answer.id}-comments`} sx={{display: 'flex', textDecoration: 'none', textAlign: "center", opacity: 0.5}}>
    ...
    <Box>
        <Card sx={{ maxWidth: "90%", mx: 'auto' }} variant={'bordered'}>
            <Flex as="a" href={`/user/${answer.user}`} sx={{ mb: 2, textDecoration: 'none', color: 'inherit', width: '100%', alignItems: "center", justifyContent: "flex-end", flexDirection: 'row' }} alignItems={"center"} justifyContent={"center"}>
